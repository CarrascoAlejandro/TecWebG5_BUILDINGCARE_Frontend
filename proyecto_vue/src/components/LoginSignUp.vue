            ...
            <div class="form-wrapper align-items-center">
                ...
                <div class="form sign-up">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" v-model="newUsername" placeholder="Nombre de Usuario" required>
                    </div>
                    <div class="input-group">
                        <i class='bx bxs-lock-alt'></i>
                        <input type="password" v-model="newPassword" placeholder="Contraseña" required>
                    </div>
                    <div class="input-group">
                        <i class='bx bxs-lock-alt'></i>
...
.head-signUp , .head-signUp{
    color: black;
}

.head-signIn img, .head-signUp img{
    width: 100%;
    max-width: 10rem;
}
.head-signIn h2, .head-signUp h2{
    font-size: 2rem;
    font-weight: 600;
    margin: 1rem 0;
}
.container {
    ...
    min-height: 100vh;
    overflow: hidden;
    background: linear-gradient(90deg, rgba(179,102,52,1) 0%, rgba(255,177,125,1) 50%, rgba(254,161,98,1) 100%);
}
...
.footer-sign-in p, .footer-sign-up p {
    margin: 1rem 0;
    font-size: .7rem;
}
